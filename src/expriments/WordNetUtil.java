...
public class WordNetUtil {
	...
	public static void main(String[] args) {
		args = new String[] { "lib/jwnl14-rc2/config/file_properties.xml" };
		if (args.length != 1) {
	...
	public static int simularity(String startWord, String endWord) {

		try {
			IndexWord start = Dictionary.getInstance().getIndexWord(POS.NOUN,
					startWord);
			IndexWord end = Dictionary.getInstance().getIndexWord(POS.NOUN,
					endWord);
